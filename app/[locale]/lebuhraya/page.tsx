    ...
    <Container>
      ...
      <div
        className={clsx(
          ...
          font.className // Sub-brand display face for the campaign page
        )}
      >
        {/* Row 1 */}
        <div className="lg:col-span-2">
          <LogoBox
            ...
            altText={t("alt.logo")}
            className="bg-lebuhraya h-full transition-shadow duration-300 hover:shadow-xl"
            width={200}
            height={70}
            priority
          />
        ...
        <div className="lg:col-span-2">
          <TextOnlyBox
            ...
            className="hover:bg-lebuhraya-deep flex h-full flex-col items-center justify-center text-center text-white transition-colors duration-300"
        ...
        <div className="lg:col-span-2">
          <TextOnlyBox
            ...
            className="hover:bg-lebuhraya-deep flex h-full flex-col items-center justify-center text-center transition-colors duration-300"
        ...
        <div className="sm:col-span-2 lg:col-span-3 lg:row-span-2">
          <BackgroundImageBox
            ...
            className="group flex min-h-75 flex-col justify-end text-white transition-shadow duration-300 hover:shadow-2xl sm:min-h-87.5 md:min-h-105"
          >
            <div className="mt-auto rounded-md bg-black/60 p-3 opacity-0 transition-opacity duration-300 group-hover:opacity-100 motion-reduce:opacity-100 pointer-coarse:opacity-100">
        ...
        <div className="col-span-1 sm:col-span-2 lg:col-span-6">
          <TextOnlyBox
            ...
            className="bg-lebuhraya-deep hover:bg-lebuhraya py-4 text-center transition-colors duration-300"
