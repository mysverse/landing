...
Terma & Syarat ini ("Terma") mengawal akses dan penggunaan anda terhadap perkhidmatan yang disediakan oleh {{name}} ({{registration}}), yang beroperasi sebagai MYSverse ("kami", "kita", atau "syarikat"). Dengan mengakses atau menggunakan perkhidmatan kami, anda bersetuju untuk terikat dengan Terma ini.

## 2. Perihalan Perkhidmatan

MYSverse ialah kumpulan pembangunan permainan yang mencipta pengalaman pada platform Roblox. Perkhidmatan kami merangkumi:

- Pembangunan dan operasi pengalaman permainan di platform Roblox
- Platform pembayaran pembangun yang memudahkan pembayaran pampasan automatik kepada pembangun dan rakan usaha sama yang menyumbang
- Penglibatan komuniti melalui laman web dan saluran sosial kami

**Penting:** MYSverse tidak menjual produk atau perkhidmatan kepada pengguna akhir dan tidak menerima pembayaran daripada pengguna. Platform pembayaran kami digunakan secara eksklusif untuk mengagihkan pembayaran kepada pembangun dan rakan usaha sama yang menyumbang kepada projek kami.

## 3. Kelayakan

Untuk menyertai program pembayaran pembangun kami, anda mestilah:

- Berumur sekurang-kurangnya 18 tahun atau umur majoriti di kawasan kuasa undang-undang anda
- Menyediakan maklumat yang tepat dan lengkap seperti yang diperlukan untuk pemprosesan pembayaran
- Mematuhi semua undang-undang dan peraturan yang terpakai di kawasan kuasa undang-undang anda

## 4. Terma Pembayaran Pembangun

Pembayaran pembangun diproses melalui pemproses pembayaran pihak ketiga. Dengan menyertai program pembayaran pembangun, anda bersetuju dengan perkara berikut:

- Pembayaran adalah pampasan untuk kerja pembangunan, penciptaan kandungan, atau sumbangan lain kepada projek MYSverse seperti yang dipersetujui antara anda dan MYSverse
- Anda bertanggungjawab untuk menyediakan maklumat pembayaran yang tepat dan untuk sebarang cukai atau kewajipan yang timbul daripada pembayaran yang diterima
- Jumlah, jadual dan syarat pembayaran ditentukan oleh persetujuan awal antara anda dan MYSverse
- Kami berhak untuk menahan atau menangguhkan pembayaran jika kami secara munasabah mengesyaki aktiviti penipuan, pelanggaran Terma ini, atau maklumat yang tidak tepat
- Pembayaran tertakluk kepada terma dan syarat pemproses pembayaran pihak ketiga yang digunakan untuk memudahkan transaksi

## 5. Harta Intelek

Semua kandungan, tanda dagangan, logo dan harta intelek yang dipaparkan di laman web kami dan dalam pengalaman permainan kami adalah hak milik {{name}} atau pemilik masing-masing. Anda tidak dibenarkan mengeluarkan semula, mengedar atau mencipta karya terbitan daripada kandungan kami tanpa kebenaran bertulis terlebih dahulu.

Sumbangan yang dibuat oleh pembangun di bawah program pembayaran adalah tertakluk kepada terma harta intelek yang dipersetujui antara pembangun dan MYSverse pada masa penglibatan.

## 6. Kelakuan Pengguna

Anda bersetuju untuk tidak:

- Menggunakan perkhidmatan kami untuk sebarang tujuan yang menyalahi undang-undang atau tidak dibenarkan
- Menyediakan maklumat palsu atau mengelirukan berkaitan dengan pembayaran atau pendaftaran akaun
