...
export default function Banner() {
  ...
  return (
    <Transition show={isVisible && !isLoading}>
      ...
      >
        <div className="pointer-events-auto flex items-center justify-between gap-x-6 bg-linear-to-r from-red-600  to-red-500 px-6 py-2.5 sm:rounded-xl sm:py-3 sm:pl-4 sm:pr-3.5">
